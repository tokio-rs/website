...
We have to make sure the task is allowed to live forever, in order to let the compiler
give the permission to tokio to make the task run as long as it needs to.
