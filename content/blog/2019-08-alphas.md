...
ago][tokio-ann]. When Tokio was first released, it contained a minimal,
...
components to use [`std::future`][std_future], and all usage of `futures` 0.1
has been removed.
...
is ready. Estimating software release dates is hard, but let's aim for before the
end of the year.
